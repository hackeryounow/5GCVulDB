#!/usr/bin/env python3
"""
VUL-20260730-POC: Kamailio CDP Diameter Heap Overflow
=========================================================
...
---
Edit .env file
DOCKER_HOST_IP、UPF_ADVERTISE_IP to your system address
---
docker compose -f sa-vonr-deploy-2.8.1-gamma.yaml up -d


git clone -b v1.4.0 https://github.com/hackeryounow/coresimrunner.git
cd coresimrunner 

python3 coresim_runner.py --mode provision --core-network open5gs --count 5
cd -
python3 poc.py [--target icscf|scscf|all]
"""
